...
# load model weights
model_weight_path = r"E:\save-github\deep-learning-all\image-classification\15_vision_transformer\weights\model-19.pth"
...
y_pre.to_csv('submit/result-vit.csv', index=False)
