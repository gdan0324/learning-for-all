...
from train_utils import dboxes300_coco, Encoder, PostProcess
...
class SSD300(nn.Module):
    def __init__(self, backbone=None, num_classes=21):
        ...
        for nd, oc in zip(self.num_defaults, self.feature_extractor.out_channels):
            ...
            location_extractors.append(nn.Conv2d(oc, nd * 4, kernel_size=3, padding=1)) # faster rcnn中这里是nd * 4 * num_classes
    ...
    def _build_additional_features(self, input_size):
        ...
        for i, (input_ch, output_ch, middle_ch) in enumerate(zip(input_size[:-1], input_size[1:], middle_channels)):
            ...
            layer = nn.Sequential(
                nn.Conv2d(input_ch, middle_ch, kernel_size=1, bias=False),  # 因为使用BN层，所以将bias设置为false
...
class Loss(nn.Module):
    ...
    def _location_vec(self, loc):
        ...
        :return:
        """
        # 乘以 self.scale_xy 一个小tricks，能跟更加快速收敛
