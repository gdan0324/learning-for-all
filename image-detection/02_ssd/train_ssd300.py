...
def create_model(num_classes=21):
    ...
    pre_ssd_path = "./backbone/nvidia_ssdpyt_amp_200703.pt"
...
def main(parser_data):
    ...
    # 新建文件保存路徑
    save_weight_path = os.path.join(args.output_dir,
    ...
    for epoch in range(parser_data.start_epoch, parser_data.epochs):
        ...
        torch.save(save_files, os.path.join(save_weight_path, "ssd300-model-{}.pth".format(epoch)))
