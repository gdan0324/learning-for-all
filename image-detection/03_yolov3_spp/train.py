...
def train(hyp):
    ...
    # 原论文当中，每训练64张图片就更新一次权重。  如果batch_size设置为4，每迭代16步才取更新权重
    ...
    # 对 class loss 和 objectness loss 调整
    ...
    if opt.freeze_layers:
        ...
        # 总共训练3x2=6个parameters, 三个卷积层，每个卷积层有权重和偏置
    ...
    # coco = None
    coco = get_coco_api_from_dataset(val_dataset)   # 先把标签信息都读取一遍，方便使用pycocotools去计算map
...
if __name__ == '__main__':
    ...
    # 设置为False，默认只冻结darknet53，darknet53之外的都训练；True的话就只训练三个预测器
