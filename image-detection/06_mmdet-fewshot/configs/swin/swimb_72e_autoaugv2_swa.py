...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='CocoDataset',
            ann_file='data/TianchiFilter/annotations/wu.json',
            img_prefix='data/TianchiFilter/images/',
            pipeline=[
                dict(type='LoadImageFromFile'),
    ...
    val=dict(
        type='CocoDataset',
        ann_file='data/TianchiFilter/annotations/wu_val.json',
        img_prefix='data/TianchiFilter/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
swa_training = True
swa_load_from = '/disk/sde/wzr/mmm/swimb/swim7.0/epoch_72.pth'
