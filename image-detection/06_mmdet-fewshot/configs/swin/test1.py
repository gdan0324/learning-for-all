...
test_pipeline = [
    ...
    dict(
        type='MultiScaleFlipAug',
        img_scale=[(1666, 800), (1666, 1000), (1666, 1200), (1666, 1400)],
        flip=True,
        transforms=[
            dict(type='Resize', keep_ratio=True),
            dict(type='RandomFlip'),
...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file='data/val/' + 'annotations/val2017_1.json',
...
max_epochs = 36
num_last_epochs = 5
# load_from = "/disk/sde/wzr/mmm/swimb/swimb2.0/best_bbox_mAP_epoch_48.pth"
