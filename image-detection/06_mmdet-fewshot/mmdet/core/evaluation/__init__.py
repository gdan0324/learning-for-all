...
from .class_names import (cityscapes_classes, coco_classes, dataset_aliases,
                          ...
                          oid_v6_classes, voc_classes, xray_classes, fewshot_classes, fruit_classes, tree_classes)
...
__all__ = [
    ...
    'oid_challenge_classes', 'INSTANCE_OFFSET', 'xray_classes', 'fewshot_classes', 'fruit_classes', 'tree_classes'
]
