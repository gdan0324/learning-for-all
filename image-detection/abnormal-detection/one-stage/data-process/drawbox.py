...
TXT_PATH = r"E:\save-github\deep-learning-all\object-detection\02_ssd\save_weights\weight20220903-102345\detect-results"
OUT_PATH = r"E:\save-github\deep-learning-all\object-detection\02_ssd\save_weights\weight20220903-102345\detect-results\vi"
########
...
for images in os.listdir(IMG_PATH):
    ...
    with open(os.path.join(TXT_PATH,os.path.splitext(images)[0] + '.txt'),'r') as file:
        ...
        for line in lines:
            ...
            draw.rectangle([int(content_list[2]), int(content_list[3]), int(content_list[4]), int(content_list[5])],outline='red',width=1)  # 画bbox
